/* Dada uma lista duplamente encadeada, crie uma função que retorne 1 caso os elementos formem um palindromo ou 0 em caso contrário
(Palíndromo são palavras que se pode ler, indiferentemente, da esquerda para a direita ou vice-versa). Utilize o campo código para a verificação*/
